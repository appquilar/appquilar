            ...
            <div className="flex items-start gap-3">
                ...
                <div className="space-y-2">
                    <p className="text-sm font-semibold">
                        La suscripcion de tu empresa esta inactiva
                    </p>
                    <p className="text-sm text-slate-700">
                        Detectamos una cancelacion por problema de pago. Revisa la gestion de la suscripcion para recuperar el acceso completo de tu equipo.
                    </p>
                    <Link
